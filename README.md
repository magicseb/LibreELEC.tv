...
**Build Note about RPi4**

First, build it as normal : PROJECT=RPi DEVICE=RPi4 ARCH=arm make
Then do : PROJECT=RPi DEVICE=RPi4 ARCH=arm scripts/clean SDL2-git
And redo : PROJECT=RPi DEVICE=RPi4 ARCH=arm make image

Do this if emulationstation doesn't run
