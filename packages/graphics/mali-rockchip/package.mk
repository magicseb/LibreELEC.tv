...
makeinstall_target() {
  ...
  mkdir -p $SYSROOT_PREFIX/usr/include
   ...
   # cp -PRv include/FBDEV $SYSROOT_PREFIX/usr/include
  ...
  mkdir -p $SYSROOT_PREFIX/usr/lib
    ...
    ln -sfv libMali.so $SYSROOT_PREFIX/usr/lib/libEGL.so.1.4
    ln -sfv libEGL.so.1.4 $SYSROOT_PREFIX/usr/lib/libEGL.so.1
    ln -sfv libmali.so $SYSROOT_PREFIX/usr/lib/libGLESv2.so
    ln -sfv libmali.so $SYSROOT_PREFIX/usr/lib/libGLESv2.so.2
    ln -sfv libmali.so $SYSROOT_PREFIX/usr/lib/libGLESv2.so.2.0
    ln -sfv libmali.so $SYSROOT_PREFIX/usr/lib/libgbm.so
    ln -sfv libMali.so $SYSROOT_PREFIX/usr/lib/libGLESv1_CM.so.1.1
    ln -sfv libGLESv1_CM.so.1.1 $SYSROOT_PREFIX/usr/lib/libGLESv1_CM.so.1
    ln -sfv libGLESv1_CM.so.1 $SYSROOT_PREFIX/usr/lib/libGLESv1_CM.so
  ...
  mkdir -p $INSTALL/usr/lib
    ...
    ln -sfv libmali.so $INSTALL/usr/lib/libEGL.so.1.4
    ln -sfv libMali.so $INSTALL/usr/lib/libGLESv1_CM.so.1.1
    ln -sfv libGLESv1_CM.so.1.1 $INSTALL/usr/lib/libGLESv1_CM.so.1
    ln -sfv libGLESv1_CM.so.1 $INSTALL/usr/lib/libGLESv1_CM.so
    ln -sfv libmali.so $INSTALL/usr/lib/libGLESv2.so
    ln -sfv libmali.so $INSTALL/usr/lib/libGLESv2.so.2
    ln -sfv libmali.so $INSTALL/usr/lib/libGLESv2.so.2.0
